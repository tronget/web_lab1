export const checkBoundaries = (num: number, left: number, right: number): boolean => {
...
export const addClassUntilTrue = (condition: CheckHandler, el: HTMLElement, className: string): void => {
    if (!condition()) {
